<# 
.SYNOPSIS
    Disable Microsoft Edge Pre-Load
.DESCRIPTION 
    Disable Microsoft Edge Pre-Load on Windows boot
.NOTES 
    Vertsion:   1.0
...
# Log Section
$logLocation = 'C:\Temp\'
$logFile = 'Disable-EdgePreLoad-log.txt'
...
Try {
    ...
    CheckFilePath
    Write-Log "`t Step 2 - Disabling Edge preload"
