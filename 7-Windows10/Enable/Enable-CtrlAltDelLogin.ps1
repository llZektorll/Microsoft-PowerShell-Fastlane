<# 
.SYNOPSIS
    Enable Ctrl+Alt+Del for the Windows login screen
.DESCRIPTION 
    Windows will requiere Ctrl+Alt+Del before login
.NOTES 
    Vertsion:   1.0
...
# Log Section
$logLocation = 'C:\Temp\'
$logFile = 'Enable-CrtlAltDelLogin-log.txt'
...
Try {
    ...
    CheckFilePath
    Write-Log "`t Step 2 - Enable Ctrl+Alt+Del"
